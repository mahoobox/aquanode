...
import { registerUser, getUsers } from "../../../services/users.api";
...
const UsersModal = ({ title, style, content, id }: UsersModalProps) => {
	...
	const getRoleMutation = useMutation({
		mutationFn: () => getUsers(id as number),
		onSuccess: (data) => {
	...
	const registerMutation = useMutation({
		mutationFn: () => registerUser(dataRole),
		onSuccess: (data) => {
			setAnimation(false);
			toast.success("Rol creado con éxito");
			queryClient.setQueryData(["roles"], (oldData: User[] | undefined) =>
